/**
 * Per-channel switches that are a single on/off value on the console.
 *
 ...
 *
 * The console is inconsistent about how it reports them — `48v` comes back as
 * a JavaScript boolean while `polarity` and the processor switches come back
 * as 1/0 numbers — so read them through `getSwitch()`, which normalises.
 */
export const ChannelSwitch = {
	/** Phantom power. Can damage ribbon microphones; confirm before enabling. */
	phantom: "48v",
